if(file_exists("Multi.sav"))
{
    ...
    mFireMult[1] = ini_read_real("save1","mFireMult[0]",mFireMult[1]);
    mFireMult[2] = ini_read_real("save1","mFireMult[0]",mFireMult[2]);
    mFireMult[3] = ini_read_real("save1","mFireMult[0]",mFireMult[3]);
    ...
    mFrostMult[1] = ini_read_real("save1","mFrostMult[0]",mFrostMult[1]);
    mFrostMult[2] = ini_read_real("save1","mFrostMult[0]",mFrostMult[2]);
    mFrostMult[3] = ini_read_real("save1","mFrostMult[0]",mFrostMult[3]);
    ...
    mLightningMult[1] = ini_read_real("save1","mLightningMult[0]",mLightningMult[1]);
    mLightningMult[2] = ini_read_real("save1","mLightningMult[0]",mLightningMult[2]);
    mLightningMult[3] = ini_read_real("save1","mLightningMult[0]",mLightningMult[3]);
